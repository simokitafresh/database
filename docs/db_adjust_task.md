...
|-------|----------|----------|----------|------------|
| Phase 1: 検出サービス | 9 | TID-ADJ-001〜009 | 14.5h | ⬜ 未着手 |
| Phase 2: API | 6 | TID-ADJ-010〜015 | 7.5h | ⬜ 未着手 |
| Phase 3: Cron統合 | 3 | TID-ADJ-016〜018 | 2h | ⬜ 未着手 |
| Phase 4: ドキュメント | 3 | TID-ADJ-019〜021 | 2.5h | ⬜ 未着手 |
| **合計** | **21** | - | **26.5h (約4日)** | - |
